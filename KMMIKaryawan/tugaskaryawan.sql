...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.0.4&nocache=6284663620ltr&server=1">
...
<input type="hidden" name="token" value="7265467b2a254b5f366e447154766c3a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="tugaskaryawan" targettable="karyawan">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `tugaskaryawan`.`karyawan` ( `nik` VARCHAR(50) NOT NULL ,  `nama` VARCHAR(30) NOT NULL ,  `jabatan` VARCHAR(50) NOT NULL ,  `agama` VARCHAR(20) NOT NULL ,  `norekening` VARCHAR(50) NOT NULL ,  `alamat` TEXT NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
